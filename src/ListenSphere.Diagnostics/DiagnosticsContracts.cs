...
public sealed record DiagnosticRuntimeSnapshot(
    ...
    double EstimatedNetworkJitterMilliseconds,
    long BluetoothEncodedFrames,
    long BluetoothDecodedFrames,
    long BluetoothTimestampGaps,
    long BluetoothQueueDrops,
    long BluetoothDecodeFailures,
    int BluetoothQueueDepth,
    long MixedFrames,
